...
////// Emissive:
                ...
                float3 emissive = lerp(float3(_Texture_var.r,_Texture_var.r,_Texture_var.r),lerp(lerp(_Texture_var.rgb,((i.posWorld.g.r*_tiling)+lerp(_color_bottom.rgb,_color_top.rgb,dot(i.normalDir,__Color3.rgb))),_opacity_color),(node_1451.r*_color_Y.rgb + node_1451.g*_color_X.rgb + node_1451.b*_color_Z.rgb),_opacity_shadow),(_Fade+saturate(((1.0 - i.posWorld.g.r)+(_Gradient*4.0+-2.0)))));
